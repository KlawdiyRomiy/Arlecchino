...
запускает Wails v3 alpha генератор pinned к `v3.0.0-alpha.83`. Dry-run по умолчанию пишет
...
- Добавлен temp-only repro harness для pinned Wails `v3.0.0-alpha.83`
