...
APP_ENV_ARGS=(
  ...
  --arle-env "ARLECCHINO_WAILS3_SMOKE_SECOND_INSTANCE_ARGS=${ARLECCHINO_WAILS3_SMOKE_SECOND_INSTANCE_ARGS:-}"
  --arle-env "ARLECCHINO_WAILS3_SMOKE_BACKGROUND_SAMPLE=${ARLECCHINO_WAILS3_SMOKE_BACKGROUND_SAMPLE:-0}"
