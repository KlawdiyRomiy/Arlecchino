...
MODULE_ROOT="$(go env GOMODCACHE)/github.com/wailsapp/wails/v3@v3.0.0-alpha2.114"
...
(cd "$WORK_DIR" && \
  ...
  go mod edit -require github.com/wailsapp/wails/v3@v3.0.0-alpha2.114 && \
