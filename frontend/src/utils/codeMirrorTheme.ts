...
export const codeEditorStyles = EditorView.theme(
  {
    ...
    ".cm-mini-search-icon[hidden], .cm-mini-search-count[hidden], .cm-mini-search-nav[hidden]":
      {
        display: "none",
      },
    ...
    ".cm-mini-search input::placeholder": {
      color: "var(--text-tertiary)",
    },
    ...
    ".cm-mini-search[data-invalid='true'] .cm-mini-search-field": {
    ...
    ".cm-mini-search button": {
      ...
      cursor: "pointer",
      transition:
        "border-color 150ms ease, background-color 150ms ease, color 150ms ease, opacity 120ms ease",
    },
    ".cm-mini-search button:hover": {
      color: "var(--text-primary)",
      borderColor: "var(--shell-border-strong)",
    },
    ".cm-mini-search button:disabled": {
      cursor: "default",
      opacity: "0.45",
    },
    ".cm-mini-search button svg": {
      display: "block",
    },
    ".cm-tooltip": {
