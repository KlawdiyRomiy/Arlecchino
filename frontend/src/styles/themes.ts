...
const blackprintEditor: EditorThemePalette = {
  ...
  tooltipBg: "rgba(4, 4, 4, 0.985)",
  tooltipBgStrong: "rgba(12, 12, 12, 0.99)",
  tooltipShadow:
...
const createThemeCssVariables = (
  ...
  "--button-primary-bg": colors.textPrimary,
  "--button-primary-bg-hover": `color-mix(in srgb, ${colors.textPrimary} 88%, ${colors.bgPanel})`,
  "--button-primary-text": colors.bg,
  "--button-primary-border": colors.textPrimary,
  "--button-primary-border-hover": `color-mix(in srgb, ${colors.textPrimary} 88%, ${colors.bgPanel})`,
  ...
  "--explorer-file-label-0": `color-mix(in srgb, ${options.accentBrand} 76%, ${colors.textPrimary})`,
  "--explorer-file-label-1": `color-mix(in srgb, ${options.statuses.info} 76%, ${colors.textPrimary})`,
  "--explorer-file-label-2": `color-mix(in srgb, ${options.statuses.success} 74%, ${colors.textPrimary})`,
  "--explorer-file-label-3": `color-mix(in srgb, ${options.statuses.warning} 68%, ${colors.textPrimary})`,
  "--explorer-file-label-4": `color-mix(in srgb, ${options.statuses.error} 76%, ${colors.textPrimary})`,
  "--explorer-file-label-5": `color-mix(in srgb, ${editor.accent} 78%, ${colors.textPrimary})`,
  "--explorer-file-label-6": `color-mix(in srgb, ${editor.keyword} 78%, ${colors.textPrimary})`,
  "--explorer-file-label-7": `color-mix(in srgb, ${editor.function} 76%, ${colors.textPrimary})`,
  "--explorer-file-label-8": `color-mix(in srgb, ${editor.string} 74%, ${colors.textPrimary})`,
  "--explorer-file-label-9": `color-mix(in srgb, ${colors.textPrimary} 82%, ${colors.textSecondary})`,
...
const blackprintTheme = createThemeDefinition({
  ...
  variableOptions: {
    ...
    accentBrand: "#cfcfcf",
    accentBrandSoft: "rgba(207, 207, 207, 0.12)",
    statuses: {
      success: "#22c55e",
      warning: "#f59e0b",
      error: "#ef4444",
