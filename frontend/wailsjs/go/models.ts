export namespace brain {
	...
	export class TraceSuggestion {
	    ...
	    static createFrom(source: any = {}) {
	        return new TraceSuggestion(source);
	    }
	...
	export class CompletionTrace {
	    ...
	    static createFrom(source: any = {}) {
	        return new CompletionTrace(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.accessChain = source["accessChain"];
	        this.resolvedNamespace = source["resolvedNamespace"];
	        this.cacheHit = source["cacheHit"];
	        this.beforeFilter = source["beforeFilter"];
	        this.afterPrefixFilter = source["afterPrefixFilter"];
	        this.afterContextFilter = source["afterContextFilter"];
	        this.afterDedup = source["afterDedup"];
	        this.resultCount = source["resultCount"];
	        this.sourceCounts = source["sourceCounts"];
	        this.topSuggestions = this.convertValues(source["topSuggestions"], TraceSuggestion);
	    }
