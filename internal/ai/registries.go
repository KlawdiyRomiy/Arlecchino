...
func (s *Service) ListChatActions() []AIChatActionDescriptor {
	return []AIChatActionDescriptor{
		...
		},
		{
			...
			ApprovalBoundary:     "terminal checks require visible approval and audit",
		},
		{
			ID:                AIChatActionPlan,
			Name:              "Plan",
...
func (s *Service) ListAgentProfiles() []AIAgentProfileDescriptor {
	return []AIAgentProfileDescriptor{
		...
		},
		{
			ID:          "plan-architect",
			Name:        "Plan Architect",
			Description: "Structured planning profile with read-only project context.",
			BuiltIn:     true,
			Enabled:     true,
		...
		},
		{
			ID:          "debug-operator",
			Name:        "Debug Operator",
			Description: "Debugging profile that can propose approval-gated terminal diagnostics.",
			BuiltIn:     true,
			Enabled:     true,
...
func (s *Service) ListTools() []AIToolDescriptor {
	return []AIToolDescriptor{
		...
		},
		{
			...
			ExecutionAvailable:     true,
			DefaultApprovalMode:    AIApprovalModeAskEachTime,
			HardDenyCategories:     []AIToolHardDenyReason{AIToolHardDenyReasonSecrets, AIToolHardDenyReasonDestructiveShell, AIToolHardDenyReasonNonLoopbackNetwork},
			RequiresArtifactReview: true,
		},
		{
			ID:                     "git.preview",
		...
		},
		{
			...
			Description:            "Approval-gated MCP execution placeholder; blocked until an MCP executor is injected.",
			Kind:                   AIToolKindMCP,
		...
		},
		{
			...
			Description:            "Record future subagent task metadata without launching background work.",
