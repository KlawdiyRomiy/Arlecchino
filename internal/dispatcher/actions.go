...
func (r *ActionRegistry) registerDefaults() {
	defaults := []IDEAction{
		...
		{Name: "Open AI Panel", Description: "Show AI Chat panel", Icon: "sparkles", Handler: "panel.ai"},
		{Name: "Toggle AI Panel", Description: "Open or close AI Chat panel", Icon: "sparkles", Handler: "shortcut.ai.toggle", Keybinding: "cmd+r"},
		{Name: "Toggle AI Fullscreen", Description: "Open AI Chat in fullscreen mode or restore it", Icon: "maximize", Handler: "shortcut.ai.fullscreen", Keybinding: "cmd+shift+r"},
		...
		{Name: "Close AI Panel", Description: "Close AI Chat panel", Icon: "x-circle", Handler: "panel.close.ai"},
