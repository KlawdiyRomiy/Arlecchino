...
func TestResolveLanguage(t *testing.T) {
	tests := []struct {
		...
		{name: "svelte", language: "svelte", filePath: "App.svelte", canonical: "svelte", lsp: "svelte", index: "svelte", predictive: "", keyword: "javascript", fill: ""},
		{name: "astro", language: "astro", filePath: "page.astro", canonical: "astro", lsp: "astro", index: "astro", predictive: "typescript", keyword: "typescript", fill: "typescript"},
		{name: "blade", language: "blade", filePath: "welcome.blade.php", canonical: "blade", lsp: "blade", index: "blade", predictive: "", keyword: "blade", fill: ""},
		{name: "scss", language: "scss", filePath: "style.scss", canonical: "scss", lsp: "scss", index: "scss", predictive: "", keyword: "css", fill: ""},
		{name: "sass", language: "sass", filePath: "style.sass", canonical: "sass", lsp: "sass", index: "sass", predictive: "", keyword: "css", fill: ""},
		{name: "less", language: "less", filePath: "style.less", canonical: "less", lsp: "less", index: "less", predictive: "", keyword: "css", fill: ""},
		{name: "shell alias", language: "sh", filePath: "script.sh", canonical: "bash", lsp: "bash", index: "bash", predictive: "", keyword: "bash", fill: ""},
		{name: "ruby", language: "ruby", filePath: "app.rb", canonical: "ruby", lsp: "ruby", index: "ruby", predictive: "ruby", keyword: "ruby", fill: ""},
		{name: "rust", language: "rust", filePath: "main.rs", canonical: "rust", lsp: "rust", index: "rust", predictive: "", keyword: "rust", fill: ""},
